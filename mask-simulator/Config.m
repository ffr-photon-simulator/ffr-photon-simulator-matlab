classdef Config
  properties (Constant)
    ...
    ffr_3M9210 = struct('qWidth', 100*Defaults.micron, ...
                        ...
                        'nLayers', 9, ...
                        'lengthI', 5000, ...
                        'layerDensitiesI', [Config.low; Config.high; Config.low; ...
                                            Config.high; Config.low; Config.high; ...
                                            Config.low; Config.high; Config.low]; ...
                        'layerRadiiI', [1 3; 6 10; 1 3; 6 10; 1 3; 6 10; 1 3; 6 10; 1 3]; ...
