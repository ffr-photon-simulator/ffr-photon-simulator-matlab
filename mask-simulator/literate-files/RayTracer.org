...
#+begin_src octave
        function inAbsorptionRadius = withinAbsorptionRadius(obj, currentQuadrant, photon)
          ...
          for photonNum = 1:nPhotons
            ...
            while hasCrossedFFRBound == false
              ...
              if hasCrossedFFRBound == true
                ...
                inAbsorptionRadius = obj.withinAbsorptionRadius(currentQuadrant, photon);
                % Photon is inside the absorption radius.
                if inAbsorptionRadius == true
                  % If the photon was already within the absorption radius, do nothing.
                  % If not, it has entered the radius, so increase the possibleAbsorptionCount by 1.
